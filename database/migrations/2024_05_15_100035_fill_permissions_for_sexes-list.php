...
class FillPermissionsForSexesList extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSexesList constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sexes-list',
            'admin.sexes-list.index',
            'admin.sexes-list.create',
            'admin.sexes-list.show',
            'admin.sexes-list.edit',
            'admin.sexes-list.delete',
            'admin.sexes-list.bulk-delete',
        ]);
