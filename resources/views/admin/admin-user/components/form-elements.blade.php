...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('sexe_id'), 'has-success': fields.sexe_id && fields.sexe_id.valid }">
    <label class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('Sexe') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <div class="form-check">
            <input class="form-check-input" type="radio" id="sexe_male" value="1" v-model="form.sexe_id">
            <label class="form-check-label" for="sexe_male">{{ trans('male') }}</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" id="sexe_female" value="2" v-model="form.sexe_id">
            <label class="form-check-label" for="sexe_female">{{ trans('female') }}</label>
        </div>
        <div v-if="errors.has('sexe_id')" class="form-control-feedback form-text" v-cloak>@{{ errors.first('sexe_id') }}</div>
    </div>
</div>
